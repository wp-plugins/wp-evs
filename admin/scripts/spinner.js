...
(function($) {
        ...
        return this.each(function() {
            ...
            if (options == 'remove' || options == 'close') {
                ...
                if (typeof $s != 'undefined') {
                    $s.fadeTo(250, 0, function() {
											$s.remove();
										});
                    $this.removeData('spinner').removeData('opts');
                    if (o.hide) $this.fadeTo(250, 1);//$this.css('visibility', 'visible');
            ...
            $s = $('<img src="' + opts.img + '" style="position: absolute; left: ' + l +'; top: ' + t + '; width: ' + opts.width + 'px; height: ' + opts.height + 'px; z-index: ' + opts.zIndex + '; opacity: 0;" />').appendTo('body').fadeTo(250, 1);
    ...
    $.fn.spinner.defaults = {
        ...
        , height    : 32            // height of spinner img
        , width     : 32            // width of spinner img
